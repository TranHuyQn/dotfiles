...
mkdir -p /Volumes/Data/export-code/$output_dir
...
for file in $files; do
    ...
    mkdir -p /Volumes/Data/export-code/$output_dir/$(dirname $file)
    # Sao chép file vào thư mục đích
    cp $file /Volumes/Data/export-code/$output_dir/$file
done

echo "Đã xuất các file thay đổi và thêm mới vào thư mục /Volumes/Data/export-code/$output_dir"
